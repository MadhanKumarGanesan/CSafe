...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void getApicall() {
        ...
        try {
            ...
            System.out.println("mobileuserregistration---> Request Json: " + gson.toJson(loginRequest));
    ...
    private void setApicall() {
        registrationResponseCallback = new Callback<RegistrationResponse>() {
            ...
            public void onResponse(Call<RegistrationResponse> call, Response<RegistrationResponse> response) {
                ...
                System.out.println("mobileuserregistration---> Response Json: " + gson.toJson(registrationResponse));
        ...
        loginResponseCallback = new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                if (status.equals("1")) {
                    ...
                    //Adding Preferences
                    CSafePreferences.setUserId(userId);
    ...
    public void custom_dialog(final String otp, final String mobile) {
        ...
        EditText text = (EditText) dialog.findViewById(R.id.edt_otp);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otp.equals(str_otp)) {
                    dialog.dismiss();
                    setLoginApicall();
                    getLoginApicall(mobile);
                } else {
                    dialog.dismiss();
                    CommonClass.cusomAlertDialog(RegistrationActivity.this, "ATTENTION..!", "Please enter Valid OTP.");
